...
public class PlayerDetector : MonoBehaviour
{
    ...
    [Range(0, 3)]
    [SerializeField] private float detectionCheckDelay;
    ...
    {
        RaycastHit2D result = Physics2D.Raycast(transform.position, Target.position - transform.position, viewRadius, visibilityLayer);
